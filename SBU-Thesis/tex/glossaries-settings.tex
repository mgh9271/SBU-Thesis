...
\newglossarystyle{myFaToEn}{%
	...
	\renewcommand*{\glsgroupheading}[1]{\subsection*{\raggedleft\glsgetgrouptitle{##1}}}
...
%%% در این جا عباراتی مثل glg، gls، glo و ... پسوند فایل‌هایی است که برای xindy بکار می‌روند. \makeglossaries
...
%\defglsentryfmt[Persian]]{\glsgenentryfmt\ifglsused{\glslabel}{}{\LTRfootnote{\glsentryname{\glslabel}}}}
