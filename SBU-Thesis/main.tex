% !TeX document-id = {4b12fe4f-a342-4503-9e81-c2d3cd43dfb5}
% !TEX TS-program = XeLaTeX
% Command for running this example (needs latexmkrc file):
%    latexmk -bibtex -pdf main.tex

%	نمونه پایان‌نامه آماده شده با استفاده از کلاس SBU-Thesis ، نگارش 1
%	محمد مهدی غلامی، دانشگاه شهید بهشتی
%	
%	گروه پارسی‌لاتک
%	http://www.parsilatex.com
%	این نسخه، بر اساس نسخه‌ 19.08 tehran-thesis اثر آقای سینا ممکن آماده شده است.
%       https://github.com/sinamomken/tehran-thesis/releases/tag/19.08

%----------------------------------------------------------------------------------------------
% اگر قصد نوشتن پروژه کارشناسی را دارید، در خط زیر به جای msc، کلمه bsc را قرار دهید. اگر قصد نوشتن پروپوزال دکتری را دارید، از prpsl و اگر قصد نوشتن رساله دکترا را دارید، کلمه phd را قرار دهید. کلیه تنظیمات لازم، به طور خودکار، اعمال می‌شود.
...
\small
\onehalfspacing
\bibliographystyle{unsrt-fa.bst} % or plainnat-fa for author-date
